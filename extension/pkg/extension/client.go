...
// Taken from aws-samples:
// https://github.com/aws-samples/aws-lambda-extensions/blob/main/go-example-extension/extension/client.go
...
const (
	// Invoke event for lambda invoke
	Invoke EventType = "INVOKE"

	// Shutdown event for lambda environment
